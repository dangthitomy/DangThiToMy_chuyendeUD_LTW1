                ...
                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="product-short">
                                                <div class="dropdown">
                                                    <div class="dropdown-toggle" data-toggle="dropdown">Lọc sản phẩm</div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="product-price-range">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="#" class="dropdown-item">0 VND - 100.000 VND</a>
                                                        <a href="#" class="dropdown-item">101.000 VND - 300.000 VND</a>
                                                        <a href="#" class="dropdown-item">301.000 VND - 500.000 VND</a>
                                                        <a href="#" class="dropdown-item">501.000 VND - 2.000.000 VND</a>
                    ...
                    <div class="col-lg-4 sidebar">
                        <div class="sidebar-widget category">
                            ...
                            <nav class="navbar bg-light">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#"><i class="fa fa-tshirt"></i>Quần áo nam H& nữ</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="sidebar-widget brands">
                            ...
                            <ul>
                                <li><a href="#">GUMAC </a><span>(45)</span></li>
                                <li><a href="#">Couple TX </a><span>(34)</span></li>
                                <li><a href="#">JUNO </a><span>(67)</span></li>
                                <li><a href="#">Ivy Moda</a><span>(74)</span></li>
                                <li><a href="#">Việt Tiến </a><span>(89)</span></li>
                                <li><a href="#">NEM</a><span>(28)</span></li>
                            </ul>
                        </div>
