                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="contact-info">
                            <h2>Liên hệ</h2>
                            <h3><i class="fa fa-map-marker"></i>235F,Đình Phong Phú, Tăng Nhơn Phú B,TP.Thủ Đức, TP.HCM</h3>
                            <h3><i class="fa fa-envelope"></i>MOC@gmail.com</h3>
                            <h3><i class="fa fa-phone"></i>0905 649 073</h3>
                            <div class="social">
                    ...
                    <div class="col-lg-4">
                        <div class="contact-info">
                            <h2>Liên hệ</h2>
                            <h3><i class="fa fa-map-marker"></i>79,Đ.339, Phước Long B,TP.Thủ Đức, TP.HCM</h3>
                            <h3><i class="fa fa-envelope"></i>MOC@gmail.com</h3>
                            <h3><i class="fa fa-phone"></i>0905 649 073</h3>
                            <div class="social">
                                <a href=""><i class="fab fa-twitter"></i></a>
